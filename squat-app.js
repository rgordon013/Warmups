...
const exercise = {
  ...
  cues: [
    ...
    'Reach your arms forward as you slowly lower your hips to a comfortable depth.',
    'Keep your back straight and knees tracking over your toes, then stand tall.'
  ],
...
reverse.addEventListener('click', () => {
  ...
  directionLabel.textContent = isForward ? 'Lower and rise' : 'Rise and lower';
  announcement.textContent = isForward ? 'Lower and rise direction selected' : 'Rise and lower direction selected';
});

...
import { createMannequin } from './y-to-w-model.js';
...
const exercise = {
  ...
  speeds: [0.6, 1, 1.4],
  cues: [
    'Stand tall with feet shoulder-width apart and raise both arms into a Y.',
    'Lower both elbows toward your back pockets to form a W.',
    'Squeeze your shoulder blades together, then return to the Y.'
  ],
...
reverse.addEventListener('click', () => {
  ...
  directionLabel.textContent = isForward ? 'Y to W' : 'W to Y';
  announcement.textContent = isForward ? 'Y to W direction selected' : 'W to Y direction selected';
});
